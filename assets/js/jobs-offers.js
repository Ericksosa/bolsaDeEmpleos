                    ...
                    <div class="h-full border-2 border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center flex-wrap">
                                <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0 mr-2" href="#">Editar
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                        <path d="M12 20h9"></path>
                                        <path d="M16.5 3.5a2.121 2.121 0 013 3L7 19.5 3 21l1.5-4L16.5 3.5z"></path>
                                    </svg>
                                </a>
